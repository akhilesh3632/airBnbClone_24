...
import com.maskara.airBnbApp.repository.HotelMinPriceRepository;
import com.maskara.airBnbApp.repository.InventoryRepository;
...
public class InventoryServiceImpl implements InventoryService{
    ...
    public List<InventoryDto> getAllInventoryByRoom(Long roomId) {
        ...
        return inventoryRepository.findByRoomOrderByDateAsc(room)
                .stream().map((element)->modelMapper
                        .map(element,InventoryDto.class)).collect(Collectors.toList());
