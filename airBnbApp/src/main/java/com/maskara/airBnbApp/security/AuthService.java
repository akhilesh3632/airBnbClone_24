package com.maskara.airBnbApp.security;

import com.maskara.airBnbApp.dto.LoginDto;
import com.maskara.airBnbApp.dto.SignUpRequestDto;
...
public class AuthService {
    ...
    public UserDto signup(SignUpRequestDto signUpRequestDto){
        ...
        if(user != null){
            throw new RuntimeException("User is already present with the ame email id");
